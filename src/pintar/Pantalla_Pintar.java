    ...
    public void paint( Graphics g ){
        ...
        for(int i=0;i<Pintar.listapintar.size();i++){
            if(Pintar.listapintar.get(i).getTipo().equals("point")){
                ...
                g.setColor(Color.decode(Pintar.listapintar.get(i).getColor()));
                g.fillRect(Pintar.listapintar.get(i).getX(), Pintar.listapintar.get(i).getY(),(Pintar.listapintar.get(i).getX()+Pintar.listapintar.get(i).getAncho()),(Pintar.listapintar.get(i).getAlto()+Pintar.listapintar.get(i).getAlto()));
